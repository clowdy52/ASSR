...
EnumParser<SkillType>::EnumParser()
{
    ...
    string2enum["SKILL_KICKCLEAR_LEFT_LEG"] = SKILL_KICKCLEAR_LEFT_LEG;
    enum2String[SKILL_KICKCLEAR_LEFT_LEG] = SKILL_KICKCLEAR_LEFT_LEG;

    string2enum["SKILL_KICKCLEAR_RIGHT_LEG"] = SKILL_KICKCLEAR_RIGHT_LEG;
    enum2String[SKILL_KICKCLEAR_RIGHT_LEG] = SKILL_KICKCLEAR_RIGHT_LEG;
...
//正面扑球
    string2enum["SKILL_DIRECT_FIGHT"] = SKILL_DIRECT_FIGHT;
    enum2String[SKILL_DIRECT_FIGHT] = "SKILL_DIRECT_FIGHT";

//侧面扑球

    string2enum["SKILL_DAJIAO_LEFT_LEG"] = SKILL_DAJIAO_LEFT_LEG;
    enum2String[SKILL_DAJIAO_LEFT_LEG] = "SKILL_DAJIAO_LEFT_LEG";

    string2enum["SKILL_DAJIAO_RIGHT_LEG"] = SKILL_DAJIAO_RIGHT_LEG;
    enum2String[SKILL_DAJIAO_RIGHT_LEG] = "SKILL_DAJIAO_RIGHT_LEG";

    string2enum["SKILL_LONGKICK_LEFT_LEG"] = SKILL_LONGKICK_LEFT_LEG;
    enum2String[SKILL_LONGKICK_LEFT_LEG] = "SKILL_LONGKICK_LEFT_LEG";

    string2enum["SKILL_LONGKICK_RIGHT_LEG"] = SKILL_LONGKICK_RIGHT_LEG;
    enum2String[SKILL_LONGKICK_RIGHT_LEG] = "SKILL_LONGKICK_RIGHT_LEG";

    string2enum["SKILL_STABLEKICK1_LEFT_LEG"] = SKILL_STABLEKICK1_LEFT_LEG;
    enum2String[SKILL_STABLEKICK1_LEFT_LEG] = "SKILL_STABLEKICK1_LEFT_LEG";

    string2enum["SKILL_STABLEKICK1_RIGHT_LEG"] = SKILL_STABLEKICK1_RIGHT_LEG;
    enum2String[SKILL_STABLEKICK1_RIGHT_LEG] = "SKILL_STABLEKICK1_RIGHT_LEG";

    string2enum["SKILL_STABLEKICK4_LEFT_LEG"] = SKILL_STABLEKICK4_LEFT_LEG;
    enum2String[SKILL_STABLEKICK4_LEFT_LEG] = "SKILL_STABLEKICK4_LEFT_LEG";

    string2enum["SKILL_STABLEKICK4_RIGHT_LEG"] = SKILL_STABLEKICK4_RIGHT_LEG;
    enum2String[SKILL_STABLEKICK4_RIGHT_LEG] = "SKILL_STABLEKICK4_RIGHT_LEG";


    string2enum["SKILL_RIGHT_FIGHT"] = SKILL_RIGHT_FIGHT;
    enum2String[SKILL_RIGHT_FIGHT] = "SKILL_RIGHT_FIGHT";

    string2enum["SKILL_LEFT_FIGHT"] = SKILL_LEFT_FIGHT;
    enum2String[SKILL_LEFT_FIGHT] = "SKILL_LEFT_FIGHT";//old

    string2enum["SKILL_LEFT_BLOCK"] = SKILL_LEFT_BLOCK;
    enum2String[SKILL_LEFT_BLOCK] = "SKILL_LEFT_BLOCK";
    
    string2enum["SKILL_RIGHT_BLOCK"] = SKILL_RIGHT_BLOCK;
    enum2String[SKILL_RIGHT_BLOCK] = "SKILL_RIGHT_BLOCK";
    
    string2enum["SKILL_MIDDLE_BLOCK"] = SKILL_MIDDLE_BLOCK;
    enum2String[SKILL_MIDDLE_BLOCK] = "SKILL_MIDDLE_BLOCK";//new
...
bool isKickClearSkill(SkillType skill)
{
    string skillStr = EnumParser<SkillType>::getStringFromEnum( skill );
    return skillStr.find("KICKCLEAR") != string::npos;
}
