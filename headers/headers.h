...
enum SkillType {
    ...
    SKILL_DAJIAO_LEFT_LEG,
    SKILL_DAJIAO_RIGHT_LEG,

    SKILL_LONGKICK_LEFT_LEG,
    SKILL_LONGKICK_RIGHT_LEG,


    SKILL_KICKCLEAR_LEFT_LEG,
    SKILL_KICKCLEAR_RIGHT_LEG,

    SKILL_STABLEKICK1_LEFT_LEG,
    SKILL_STABLEKICK1_RIGHT_LEG,

    SKILL_STABLEKICK4_LEFT_LEG,
    SKILL_STABLEKICK4_RIGHT_LEG,
...
#define LONGKICK 4
#define KICK_CLEAR 5
#define STABLEKICK1 6
#define STABLEKICK4 7
