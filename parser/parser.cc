...
//     ss1>>closestNumber;
    ...
    //cout <<"\tReceived mes"<<message<<"\n";
    if (processHearMessage(message, hearTime+deltaServerToGameTime, playerNum, timeBallLastSeen, ballX, ballY, playerX, playerY, fallen, time, closestNumber)) {
		...
		pBall->signtingOnball=closestNumber;
            }
        ...
        cout << "\tTime: " << time << "\n";
	cout << "\tclosestNumber"<< closestNumber<<"\n";
        */
    }
